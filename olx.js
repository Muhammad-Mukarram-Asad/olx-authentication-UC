import {signUpFirebase,postAdToDb,getAdsFromDb,uploadImage} from "./olx firebase.js"
...
window.show_Ad = async function () {
  ...
  async function getAds() {
    ...
    for (let item of ads) {
      adsElement.innerHTML+=`<div onclick="goToDetail('${item.userId}')" style='border:2px solid black;
      margin:6px; display:inline-block; width: 150px'>
      <img src=${item.imageURL} width='120px';
